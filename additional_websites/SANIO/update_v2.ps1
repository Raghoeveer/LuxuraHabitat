                ...
                <div class="hero-info-boxes">
                    <div class="info-box primary-details">
                        ...
                        <div class="info-row">
                            <div class="info-box-icon" aria-hidden="true">💰</div>
                            <div>
                                <div class="info-box-title">Rs. 13k - 14k / sq.ft</div>
        ...
        <div class="container">
            ...
            <div class="usp-grid">
                ...
                <div class="usp-card">
                    ...
                    <p>Purchasing at the expected pre-launch price of Rs. 13,000 - 14,000 / sq.ft offers a significant advantage. The Old Madras Road corridor is witnessing rapid infrastructural growth, promising excellent capital appreciation and rental yields.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="pricing-grid">
                <div class="pricing-card">
                    ...
                    <div class="pricing-amount">Rs. 13k - 14k</div>
        ...
        <div class="container">
            ...
            <div class="faq-list" itemscope itemtype="https://schema.org/FAQPage">
                ...
                <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                    ...
                    <div class="faq-answer" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                        <p itemprop="text">The expected pre-launch price for the residences is exceptionally competitive, ranging between Rs. 13,000 to Rs. 14,000 per sq.ft (All Inclusive). This presents a fantastic early-bird investment opportunity.</p>
                    </div>
                </div>
...
$content = $content -replace '(?s)<div class="rera-notice">.*?</div>', '<div class="rera-notice"><strong>RERA Compliance Disclosure:</strong> This project is currently in the pre-launch phase and RERA registration is in progress (RERA No: TBA). All floor plans, images, and specifications shown are for representational purposes and subject to change. Prices are indicative only.</div>'

$content = $content -replace '(?s)<div class="footer-section">\s*<h4>RERA Information</h4>\s*<p>.*?</p>\s*<p.*?>.*?</p>\s*</div>', '<div class="footer-section"><h4>RERA Information</h4><p>RERA Number: TBA<br>Registration in Progress.</p></div>'

$content = $content -replace '(?s)<div class="footer-contact">\s*<strong>Site Address:</strong>\s*<p>Sattva Sanio<br>Opposite KRN Complex, Old Madras Road<br>Airport Road \(NH-207\)<br>North Bengaluru – 562110</p>\s*</div>', '<div class="footer-contact"><strong>Site Address:</strong><p>Sattva Sanio<br>Old Madras Road (NH-4)<br>Near KR Puram & Whitefield<br>Bangalore</p></div>'

$content = $content.Replace('An 18-acre integrated township by Sattva Group (formerly Salarpuria Sattva) in Old Madras Road, North Bengaluru. Premium 1, 2 & 3 BHK apartments near Kempegowda International Airport with 79% open space and 50+ lifestyle amenities.', 'A 10.3-acre premium residential community by Sattva Group on Old Madras Road (NH-4), Bangalore. Offering luxury 3 & 4 BHK and Duplex apartments across 7 iconic towers with world-class amenities.')
$content = $content.Replace('An 18-acre integrated township by Sattva Group (formerly Salarpuria Sattva) in Devanahalli, North Bengaluru. Premium 1, 2 & 3 BHK apartments near Kempegowda International Airport with 79% open space and 50+ lifestyle amenities.', 'A 10.3-acre premium residential community by Sattva Group on Old Madras Road (NH-4), Bangalore. Offering luxury 3 & 4 BHK and Duplex apartments across 7 iconic towers with world-class amenities.')
